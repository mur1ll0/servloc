		...
		<section class="aw-layout-content  js-content">
			...
			<div class="container-fluid">
				...
				<div class="input-group">
					...
					<textarea name="telefone" id="contato" rows="3" class="form-control" value=""></textarea>
				</div>
				<div class="input-group">
					<div class="input-group-addon"><svg-icon class="glyph-icon"><src href="static/sprite/sprite.svg#si-glyph-mail"/></svg></div>
					<input name="email" id="email" type="text" class="form-control" value="<?php echo 'nada ainda' ?>"/>
				</div>
			</div>
		</section>
